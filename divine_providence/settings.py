"""
Django settings for divine_providence project.
...
SECRET_KEY = '1abi8*ra&8vo&1@@m*wp@yj$z$*s0km#g-6_^t=yjjs#jx&%8f'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# ALLOWED_HOSTS = ['85.143.212.176']
ALLOWED_HOSTS = []
...
INSTALLED_APPS = [
	'task_dispatch.apps.InputTasksConfig',
...
ROOT_URLCONF = 'divine_providence.urls'
...
WSGI_APPLICATION = 'divine_providence.wsgi.application'
